...
const CATEGORY_PAIRINGS = {
  ...
  cold_snack: ['Игристое вино брют', 'Водка'],

  soup_light: ['Шардоне (легкое)', 'Совиньон Блан'],
  soup_cream: ['Шардоне', 'Пино Нуар'],
  soup_spicy: ['Рислинг (полусухой)', 'Гевюрцтраминер', 'Пшеничное пиво'],
  soup_meat: ['Пино Нуар', 'Темпранильо', 'Водка'],
  ...
  creamy: ['Шардоне', 'Пино Нуар'],
  tomato: ['Кьянти', 'Барбера', 'Санджовезе'],
  mushroom: ['Пино Нуар', 'Шардоне'],
};

/** ГЛОБАЛЬНЫЕ ДАННЫЕ */
let allMeals = [];
let allProducts = [];
let drinkUsageCount = new Map();
let fixedDrinkSets = new Map();
let productsStyled = false;
