...
const REAL_PAIRINGS = {
  ...
  'оливье': ['Классическая водка', 'Пино Гриджио', 'Совиньон Блан'],
  'салат с креветками и авокадо': ['Совиньон Блан','Просекко','Пино Гриджио'],
  ...
  'утка': ['Красное сухое вино','Белое сухое вино','Игристое вино (брют)'],
  'долма': ['Красное сухое вино','Розовое сухое вино','Белое сухое вино'],
  'гречка по-купечески': ['Красное сухое вино','Красное полусухое вино','Пиво'],
};
...
// ✅ ЖЁСТКО ФИКСИРУЕМ НАПИТКИ ДЛЯ ГРЕЧЕСКОГО САЛАТА
if (name.includes('греческий')) {
  return [
    'Белое сухое вино',
    'Розовое сухое вино',
    'Игристое вино (брют)'
...
// ✅ ЖЁСТКАЯ ПРАВКА ДЛЯ ДОЛМЫ
if (name.includes('долма')) {
  return [
    'Красное сухое вино',
    'Розовое сухое вино',
    'Белое сухое вино'
...
// ✅ ЖЁСТКО ДЛЯ ГРЕЧКИ ПО-КУПЕЧЕСКИ
if (name.includes('гречка')) {
  return [
    'Красное сухое вино',
...
function findDrinksForMeal(meal) {
  ...
  // УБИРАЕМ КРАСНОЕ ВИНО ДЛЯ САЛАТА С КРЕВЕТКАМИ И АВОКАДО
if (mealKey.includes('салат с креветками') && mealKey.includes('авокадо')) {
  return allProducts.filter(p =>
    ['Совиньон Блан', 'Просекко', 'Пино Гриджио'].some(name =>
