...
const foodPairings = {
    // Рыба и морепродукты
    'лосось': ['пино нуар', 'божоле', 'розовое вино', 'шардоне'],
    'тунец': ['розовое вино', 'сира/шираз (лёгкое)', 'божоле'],
    'форель': ['совиньон блан', 'рислинг (сухой)', 'пино блан'],
    'сибас': ['шардоне (не слишком дубовое)', 'верментино', 'совиньон блан'],
    'дорадо': ['верментино', 'совиньон блан', 'фumé blanc'],
    'креветки': ['шардоне', 'совиньон блан', 'шампанское брют'],
    'кальмары': ['совиньон блан', 'пино гриджио', 'верментино'],
    'мидии': ['мускаде', 'совиньон блан', 'шампанское брют'],
    'устрицы': ['шампанское брют', 'мускаде', 'шардоне (без дуба)'],
    'окунь': ['рислинг (сухой)', 'шардоне', 'пино гриджио'],
    'карп': ['рислинг (полусухой)', 'совиньон блан', 'пино гри'],
    'судак': ['шардоне', 'рислинг', 'совиньон блан'],
    'скумбрия': ['рислинг', 'совиньон блан', 'верментино'],
    'сельдь': ['аквавит', 'пильзнер', 'рислинг (кислый)'],
    
    // Мясо красное
    'стейк': ['каберне совиньон', 'сира/шираз', 'мальбек', 'бандоль'],
    'говядина': ['бордо', 'каберне совиньон', 'брунелло ди монтальчино'],
    'баранина': ['каберне совиньон', 'бордо', 'роде (красное)'],
    'свинина': ['пино нуар', 'божоле', 'дольчетто'],
    'телятина': ['пино нуар', 'шардоне', 'совиньон блан'],
    'антрекот': ['каберне совиньон', 'бордо', 'мальбек'],
    'ребрышки': ['зиндафандель', 'шираз', 'примитиво'],
    'грудинка': ['бордо', 'каберне совиньон', 'портвейн (руби)'],
    'вырезка': ['мерло', 'пино нуар', 'бордо'],
    
    // Птица
    'курица': ['шардоне', 'пино нуар', 'совиньон блан'],
    'утка': ['пино нуар', 'бордо', 'каберне совиньон'],
    'индейка': ['шардоне', 'совиньон блан', 'пино нуар'],
    'гусь': ['пино нуар', 'бордо', 'каберне совиньон'],
    'перепел': ['пино нуар', 'божоле', 'шардоне'],
    'фазан': ['пино нуар', 'бордо', 'каберне совиньон'],
    
    // Паста и пицца
    'паста с томатным соусом': ['кьянти', 'примитиво', 'неббиоло'],
    'паста с белым соусом': ['шардоне', 'пино гриджио', 'совиньон блан'],
    'паста с мясным соусом': ['барбера', 'каберне совиньон', 'бордо'],
    'пицца': ['кьянти', 'барбера', 'лэмбруско'],
    'равиоли': ['барбера', 'дольчетто', 'шардоне'],
    'лазанья': ['кьянти', 'бордо', 'каберне совиньон'],
    'спагетти карбонара': ['шардоне', 'совиньон блан', 'верментино'],
    'ризотто': ['шардоне', 'пино гриджио', 'арнеис'],
    
    // Салаты
    'цезарь': ['шардоне', 'совиньон блан', 'пино гриджио'],
    'греческий': ['ассортико', 'розовое вино', 'рецина'],
    'оливье': ['шампанское', 'игристое вино', 'светлое пиво'],
    'винегрет': ['совиньон блан', 'пино гриджио', 'розовое вино'],
    
    // Супы
    'борщ': ['бордо', 'каберне совиньон', 'тёмное пиво'],
    'щи': ['красное бургундское', 'бордо', 'пиво'],
    'том ям': ['рислинг', 'совиньон блан', 'пиво'],
    'куриный суп': ['шардоне', 'совиньон блан', 'рислинг'],
    'грибной суп': ['пино нуар', 'бордо', 'шардоне'],
    
    // Десерты
    'тёмный шоколад': ['портвейн (руби)', 'мадера', 'бофоро'],
    'молочный шоколад': ['портвейн (руби)', 'бофоро', 'сотерн'],
    'чизкейк': ['сотерн', 'асти', 'мускат'],
    'тирамису': ['марсала', 'сотерн', 'вин санто'],
    'мороженое ванильное': ['сотерн', 'асти', 'мускат'],
    'фруктовый десерт': ['сотерн', 'мускат', 'асти'],
    'медовик': ['сотерн', 'асти', 'вин санто']
};

// Категории блюд
categoryPairs: {
    'рыба жирная': ['пино нуар', 'шардоне', 'божоле'],
    'рыба белая': ['совиньон блан', 'рислинг', 'верментино'],
    'морепродукты': ['шампанское', 'мускаде', 'альбариньо'],
    'красное мясо жареное': ['каберне совиньон', 'шираз', 'мальбек'],
    'красное мясо тушеное': ['бордо', 'каберне', 'мальбек'],
    'птица': ['шардоне', 'пино нуар', 'совиньон блан'],
    'паста с томатами': ['кьянти', 'примитиво', 'барбера'],
    'салаты лёгкие': ['совиньон блан', 'пино гриджио', 'розовое'],
    'супы наваристые': ['бордо', 'каберне', 'тёмное пиво'],
    'десерты шоколадные': ['портвейн', 'бофоро', 'мадера'],
    'десерты фруктовые': ['сотерн', 'мускат', 'асти']
},

// Ключевые слова
keywordPairs: {
    'сливочный соус': ['шардоне', 'божоле', 'совиньон блан'],
    'острый': ['рислинг', 'пино гриджио', 'пиво'],
    'сладкий': ['сотерн', 'асти', 'мускат'],
    'копченый': ['портвейн', 'сира/шираз', 'виски'],
    'жареный': ['каберне совиньон', 'шираз', 'мальбек'],
    'тушеный': ['бордо', 'каберне совиньон', 'мерло'],
    'запеченный': ['шардоне', 'пино нуар', 'совиньон блан'],
    'гриль': ['каберне совиньон', 'сира/шираз', 'бордо'],
    'маринованный': ['рислинг', 'совиньон блан', 'пино гриджио'],
    'цитрусовый': ['совиньон блан', 'рислинг', 'пино гриджио'],
    'уксусный': ['рислинг', 'совиньон блан', 'пино гриджио']
};
